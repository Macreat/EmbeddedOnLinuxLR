# EmbeddedOnLinuxLR DEVelopment branch
...
- **currently work and projects** → [`work space`](./devEnv/work/)
- **simulations** → [`simulations/`](./devEnv/code/)
- **environment to develop** → [`local development environment/`](./devEnv/)
